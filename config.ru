...
The normal body temperature of a cat is between 100.5 degrees and 102.5 degrees F. A cat is sick if its temperature goes below 100 ° or above 103 °F.
...
If they have ample water, cats can tolerate temperatures up to 133 degrees F.
...
run ->(_env){[200, {"Content-Type" => "text/plain"}, [FACTS.sample]]}